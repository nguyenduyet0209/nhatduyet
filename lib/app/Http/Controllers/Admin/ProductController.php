...
class ProductController extends Controller
{
	...
	public function getProduct(){
		$data['listproduct'] = DB::table('vp_products')->join('vp_categories','vp_products.prod_cate','=','vp_categories.cate_id')->orderBy('prod_id','desc')->get();
		return view('backend.product_admin',$data);
	}
	public function getAddProduct(){
		$data['catelist'] = Category::all();
		return view('backend.add_product_admin',$data);
	}
	...
	public function getEditProduct($id){
		...
		return view('backend.edit_product_admin',$data);
	}
