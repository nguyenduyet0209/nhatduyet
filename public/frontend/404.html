...
<body>
  ...
  <main class="content-wrapper oh">
            ...
            <div class="row">
              <div class="top-bar-links">
                <ul class="col-sm-6 top-bar-acc">
                  <li class="top-bar-link"><a href="404.html#">My Account</a></li>
                  <li class="top-bar-link"><a href="404.html#">My Wishlist</a></li>
                  <li class="top-bar-link"><a href="404.html#">Newsletter</a></li>
                  <li class="top-bar-link"><a href="404.html#">Login</a></li>
                  <li class="top-bar-link"><a href="contact.html">Contact</a></li>
                </ul>

                <ul class="col-sm-6 text-right top-bar-currency-language">
                  <li>
                    Currency: <a href="404.html#">USD<i class="fa fa-angle-down"></i></a>
                    <div class="currency-dropdown">
                      <ul>
                        <li><a href="404.html#">USD</a></li>
                        <li><a href="404.html#">EUR</a></li>
                      </ul>
                    </div>
                  </li>
                  <li class="language">
                    Language: <a href="404.html#">ENG<i class="fa fa-angle-down"></i></a>
                    <div class="language-dropdown">
                      <ul>
                        <li><a href="404.html#">English</a></li>
                        <li><a href="404.html#">Spanish</a></li>
                        <li><a href="404.html#">German</a></li>
                        <li><a href="404.html#">Chinese</a></li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    <div class="social-icons">
                      ...
                      <a href="404.html#"><i class="fa fa-google-plus"></i></a>
                      <a href="404.html#"><i class="fa fa-linkedin"></i></a>
                      <a href="404.html#"><i class="fa fa-vimeo"></i></a>
                    </div>
                  </li>
                </ul>              
                ...
                <div class="nav-cart mobile-cart hidden-lg hidden-md">
                  <div class="nav-cart-outer">
                    <div class="nav-cart-inner">
                      <a href="404.html#" class="nav-cart-icon">2</a>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="nav-cart-items">
                          ...
                          <div class="nav-cart-item clearfix">
                            ...
                            <div class="nav-cart-remove">
                              <a href="404.html#"><i class="icon icon_close"></i></a>
                            </div>
                          </div>
              ...
              <div class="nav-wrap">
                <div class="collapse navbar-collapse" id="navbar-collapse">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                      <a href="404.html#" class="dropdown-toggle" data-toggle="dropdown">Categories</a>
                          ...
                          <div class="megamenu-wrap">
                            <div class="row">
                              ...
                              <div class="col-md-3 megamenu-item">
                                <h6>For Man</h6>
                                <ul class="menu-list">
                                  <li><a href="404.html#">Shirts</a></li>
                                  <li><a href="404.html#">Jeans</a></li>
                              ...
                              <div class="col-md-3 megamenu-item">
                                <h6>For Woman</h6>
                                <ul class="menu-list">
                                  <li><a href="404.html#">Dresses</a></li>
                                  <li><a href="404.html#">Coats</a></li>
                                  <li><a href="404.html#">Accessories</a></li>
                                  <li><a href="404.html#">Sandals</a></li>
                                </ul>
                              </div>
                              ...
                              <div class="col-md-3 megamenu-item">
                                <h6>Accessories</h6>
                                <ul class="menu-list">
                                  <li><a href="404.html#">Wallets</a></li>
                                  <li><a href="404.html#">Watches</a></li>
                                  <li><a href="404.html#">Belts</a></li>
                                  <li><a href="404.html#">Scarfs</a></li>
                                </ul>
                              </div>
                              ...
                              <div class="col-md-3 megamenu-item">
                                <h6>Bags</h6>
                                <ul class="menu-list">
                                  <li><a href="404.html#">Leather</a></li>
                                  <li><a href="404.html#">Sports</a></li>
                                  <li><a href="404.html#">Street Style</a></li>
            ...
            <div class="col-md-2 col-sm-4 col-xs-4 col-xxs-12">
              <div class="widget footer-links">
                ...
                <ul class="list-no-dividers">
                  <li><a href="404.html#">Our stores</a></li>
                  <li><a href="404.html#">About us</a></li>
                  <li><a href="404.html#">Business with us</a></li>
                  <li><a href="404.html#">Delivery information</a></li>
            ...
            <div class="col-md-2 col-sm-4 col-xs-4 col-xxs-12">
              <div class="widget footer-links">
                ...
                <ul class="list-no-dividers">
                  ...
                  <li><a href="404.html#">Special gifts</a></li>
                  <li><a href="404.html#">Track order</a></li>
                </ul>
              </div>
            </div>              
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 copyright sm-text-center">
              <span>
                &copy; 2017 Aha Shop, Made by <a href="../../../index.html">DeoThemes</a>
              </span>
            </div>
    ...
    <div id="back-to-top">
      <a href="404.html#top"><i class="fa fa-angle-up"></i></a>
    </div>
